...
//Module 12 delivery 2 
    ...
    // 2. Create the layout for the bubble chart.
      var bubbleLayout = {
       ...
       } while (condition);x-axis: {title: "OTU ID"},
       automargin:true
       hovermode: "closest"
      };
...
//DELIVERIBLE 2 Create a Guage Chart
...
function buildCharts(sample) {
    ...
    d3.json("samples.json").then(data) => {
      ...
      // Create variables that hold the otu_ids, otu_labels, and sample_values.
         ...
         var otu_labels =result.otu_labels.slices(0,10).reverse();
         var sample_values = result.sample_values.slices(0,10).reverse();
